...
class RegisterService extends Service 
{
	...
	// 	]);
		...
		Mail::send(
			...
			'Your profile has been reported due to receiving many blocks, your profile is now being watched by admins for suspicious behaviour. 
			It will now be marked with a red color, this may disappear over time unless you have negative fame rating in that case until your fame is positive again.'
		);
